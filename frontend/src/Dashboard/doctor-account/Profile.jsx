  ...
  return (
    ...
    <form>
        <div className='mb-5'>
            ...
            placeholder='Full Name' className='form_input'/>
        </div>
        <div className='mb-5'>
            <p className='form_label'>Email*</p>
            <input type='email' name='email' value={FormData.email} onChange={handleInputChange}
            placeholder='Email' className='form_input' readOnly aria-readonly disabled={true}/>
        </div>
        <div className='mb-5'>
            <p className='form_label'>Phone*</p>
            <input type='number' name='phone' value={FormData.phone} onChange={handleInputChange}
            placeholder='Phone number' className='form_input'/>
        </div>
        <div className='mb-5'>
            <p className='form_label'>Bio*</p>
            <input type='text' name='bio' value={FormData.bio} onChange={handleInputChange}
            placeholder='Bio' className='form_input' maxLength={100}/>
        </div>
